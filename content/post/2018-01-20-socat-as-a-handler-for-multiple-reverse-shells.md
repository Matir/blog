...
excerpt: I needed a way to handle multiple reverse shells calling back to the same C2 host.  It's a little convoluted, but I found a way to receive multiple incoming sessions and multiplex them into tmux windows.
tags:
- Security
- Tool
- Technique
